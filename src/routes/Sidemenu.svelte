...
<aside id="default-sidebar" class="" aria-label="Sidenav">
<div class="overflow-y-auto py-5 px-3 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <ul class="space-y-2">
        <li>
